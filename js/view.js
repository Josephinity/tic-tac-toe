export default class View {
    ...
    #showModal(winner) {
        if(winner) {
            this.$.winner.innerText = winner.name + " wins!";
        } else {
    ...
    #updateSquare(squareId, player) {
        const squareElement = this.$$.squares[squareId];
        squareElement.firstElementChild.classList.add("fa-solid", player.icon, player.color);
    }
