 ...
 */
export function useLocalStorage(key: string, initialValue: GameState) : [GameState, Function] {
    const [internalValue, setInternalValue] = useState<GameState>(() => {
        try {
    ...
    console.log(`internalState returned by uselocalstorage ${JSON.stringify(internalValue)}`)
